...
| **文档版本** | **变更人** | **时间** | **主要变更内容** |
| -------- | ------- | ------ | ---------- |
| v0.1.16  | AI助手   | 2026-06-11 | 完善版本管理规则：仅功能变更时更新应用内日志和发布 Release；移除非功能性日志条目 |
| v0.1.15  | AI助手   | 2026-06-11 | dist/ 移出 git 追踪，加入 .gitignore；打包脚本自动压缩 zip，便于上传 GitHub Release |
